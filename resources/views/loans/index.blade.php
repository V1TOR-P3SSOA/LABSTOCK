                            ...
                            @foreach ($loans as $loan)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('loans.edit', $loan->id) }}" class="text-indigo-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-indigo-100">Editar</a>
